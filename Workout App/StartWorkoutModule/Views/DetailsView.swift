...
class DetailsView: UIView {
    ...
    private let repsResultLabel = UILabel(text: "20", font: .robotoMedium24(), textColor: .specialGray)
    ...
    private func setupViews() {
        ...
        repsStackView = UIStackView(arrangedSubviews: [repsLabel, repsResultLabel], axis: .horizontal, spacing: 10)
